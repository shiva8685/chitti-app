...
<p class="taglinks" style="padding:10px;color:white">FIXED CHITTIS </p>
</a>
...
$sqld = "SELECT * FROM action_new_chitti WHERE status='published' AND type='action'";
...
<p>Commission amount&emsp;Rs: <b><?php echo $row['chitti_com']; ?></b></p>
...
<button class="button1" style="margin-left: 620px;background-color: red;">&emsp;Sawal&emsp;</button>
</a>
