...
?>
  ...
  function paidAmount(val,id){
	  ...
	  var paying_amount =  document.getElementById("amount_paid"+id).value;
...
<tr id="row<?php echo $row['sno']; ?>">
 ...
 <select id="status<?php echo $row['sno']; ?>" name="status" >
	...
	<td><button id="saveBtn<?php echo $row['sno']; ?>" class="button" style="display:none;" onclick="saveData(<?php echo $row['sno']; ?>,'<?php echo $row['user_id']; ?>')">&emsp;Save&emsp;</button></td>
