...
<h2>CREATE NEW ACTION CHITTI</h2>
...
<tr>
  ...
  <tr>
  <td><input type="text" id="chittinumber" name="chittinumber" onkeyup="checkChttiNumber(this.value)" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" placeholder="Enter chitti no"  required></td>
  ...
  <td><select id="chittivalue" onchange="getComission(this.value)" name="chittivalue" required>
			  ...
			  <option value="15">15 Lacks</option>
			   ...
			   <td><input type="number" id="chitti_com" name="chitti_com" maxlength="10" placeholder="Enter Commission"  required></td>
