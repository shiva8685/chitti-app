...
//alert(str_e);
//alert(msg);
userPayableAmount = document.getElementById("userPayableAmount"+sno).value;
...
//alert("res");
 //window.location="notifications.php";
  ...
  function getPaymentEachMonth(mnth,id,mobile,table,userId,cValue){
...
<div class="container" style="background: #039be5;position: fixed;z-index: 9999;color: white;margin-top: -20px;height: 25%;">
<h2>FIXED PAYMENT ENTRY
<br>
<span class="taglinks" style="padding:10px;color:lightblue;font-size:15px;"><?php echo $_GET['name']; ?> </span>
...
$payMonth = $_GET["m"];
$payChitti = $_GET["c"];
$sqln = "SELECT * FROM action_new_chitti WHERE chitti_number = '$payChitti' ";
//echo $sqln;
...
$sqld = "SELECT * FROM ".$service." WHERE user_id = '$user' ";
//echo $sqld;
...
<input type="hidden" id="userPayableAmount<?php echo $row['sno']; ?>" name="userPayableAmount<?php echo $row['sno']; ?>" value="<?php echo $commission_amount; ?>">
...
<tr id="row<?php echo $row['sno']; ?>">
   ...
   <td>
    ...
    <td>
	<a href="single_user_all_details.php?t=<?php echo $service; ?>&p=<?php echo $row['mobile']; ?>&m=<?php echo $row['months']; ?>&v=<?php echo $row['chitti_value']; ?>&mem=<?php echo $rown["members"]; ?>&n=<?php echo $row['name']; ?>&comsion=<?php echo $rown['chitti_com']; ?>&uid=<?php echo $user; ?>" > 
	...
	<td>
	 ...
	 <select class="mselect" id="month<?php echo $row['sno']; ?>" onchange="getPaymentEachMonth(this.value,<?php echo $row['sno']; ?>,<?php echo $row['mobile']; ?>,'<?php echo $rown['chitti_number']; ?>','<?php echo $row['user_id']; ?>',<?php echo $row['chitti_value']; ?>)" name="month" style="width:100px">
	 <option value="SELECT">SELECT</option>
	  <option value="<?php echo $_GET['m']; ?>"><?php echo $_GET['m']; ?></option>
	 <?php
   ...
   <td> <input class="hi" type="number" id="amount_paid<?php echo $row['sno']; ?>" onkeyup="paidAmount(this.value,'<?php echo $row['sno']; ?>')" name="amount_paid" style="width:100px" value="">
