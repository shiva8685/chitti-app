...
?>
  ...
  function paidAmount(val,id,pAmount){
	  
	   payCommisstion = <?php echo $commission_amount; ?>;
	  
	   var cValue = '<?php echo $_GET["v"]; ?>';
	  // commisstion = commisstion+(cValue*pAmount);
	 // alert(commisstion);
...
<tr id="row<?php echo $row['sno']; ?>">
   ...
   <td>
	...
	<td>
	 ...
	 <select class="mselect" id="month<?php echo $row['sno']; ?>" onchange="getPaymentEachMonth(this.value,<?php echo $row['sno']; ?>,<?php echo $row['mobile']; ?>,'<?php echo $row['user_id']; ?>')" name="month" style="width:100px">
...
?>
 <td> <input class="hi" type="number" id="amount_paid<?php echo $row['sno']; ?>" onkeyup="paidAmount(this.value,'<?php echo $row['sno']; ?>',<?php echo $pAmount; ?>)" name="amount_paid" style="width:100px" value="">
