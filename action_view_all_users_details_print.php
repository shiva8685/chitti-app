...
var curURLC = '<?php echo ucfirst($_GET["t"]); ?>'+"_user_details_print"; 
history.replaceState(history.state, '', '/');
window.print();
history.replaceState(history.state, '', curURLC);
function printPage() {
	var curURL = window.location.href;
var curURLC = '<?php echo ucfirst($_GET["t"]); ?>'+"_user_details_print"; 
history.replaceState(history.state, '', '/');
...
<div class="back">
<h2><?php echo strtoupper($_GET["t"]); ?> DEATAILS </h2>


<h5 style="color:gray"><b><?php echo ucfirst($_GET["t"]); ?>&emsp;<?php echo $_GET["m"]; ?> Months&emsp;<?php echo $_GET["v"]; ?> Lacks&emsp; <?php echo $_GET["mem"]; ?> Members&emsp; <?php echo $_GET["d"]; ?></b></h5>
